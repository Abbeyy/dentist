...
export const Home = () => (
  <div className="flex flex-col lato">
    <div className="flex flex-col xs:flex-row shadow-inner justify-apart">
      ...
      <h1
        className={
          "flex mt-[1rem] drop-shadow-xl uppercase tracking-[1.5rem] mt-0 top-[22%] top-[18%] absolute self-left break-words max-w-[50%] xs:max-w-[30%] mx-[2rem] xs:ml-[4rem] font-bold tracking-wider text-teal-800 text-xl xs:text-4xl z-10"
        }
      >
        {STRINGS.companyName}
      </h1>
    ...
    <div className="flex flex-col gap-y-[2rem] lg:flex-row flex-1 mx-[2rem] sm:mx-[4rem] md:mx-[10rem] lg:space-x-[6rem] flex-row py-[4rem] lg:justify-evenly">
      ...
      <div className="flex flex-col items-center justify-center flex-1 space-y-2">
        ...
        <p className="flex flex-1 text-neutral-900 text-lg text-center tracking-normal">{`We understand that visiting the dentist can be stressful. We strive to create a welcoming and comfortable environment for our patients.`}</p>
      </div>
      <div className="flex flex-col items-center justify-center flex-1 space-y-2">
        <GiAlarmClock className="drop-shadow-xl" color="#2dd4bf" size={60} />
        <p className="flex flex-1 text-neutral-900 text-lg text-center tracking-normal">{`Don't wait any longer to take care of your dental health - schedule an appointment with us today.`}</p>
      </div>
    </div>

    <div className="flex flex-1 items-center gap-[1rem] flex-row flex-wrap justify-center self-center mx-[2rem] mb-[4rem]">
    ...
    <div className="flex px-[2rem] xs:px-[4rem] flex-col gap-[1rem] md:flex-row my-20 md:px-40 md:space-x-10">
